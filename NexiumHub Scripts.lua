...
local gumanbaScripts = {
    ...
    -- NEW GAMES FROM output.txt
    ["+1SpeedBridgeBuilding"] = "+1SpeedBridgeBuilding",
    ["1HeightSlide"] = "1HeightSlide",
    ["1SkillPointLegends"] = "1SkillPointLegends",
    ["1SpeedBikeEscape"] = "1SpeedBikeEscape",
    ["1SpeedBridgeBuilding"] = "1SpeedBridgeBuilding",
    ["1SpeedCarEscape"] = "1SpeedCarEscape",
    ["1SpeedDinosaurEscape"] = "1SpeedDinosaurEscape",
    ["1SpeedEscapeforBrainrots"] = "1SpeedEscapeforBrainrots",
    ["1SpeedPerStep"] = "1SpeedPerStep",
    ["1SpeedRaftEscape"] = "1SpeedRaftEscape",
    ["1SpeedRockEscape"] = "1SpeedRockEscape",
    ["1SpeedSchoolEscape"] = "1SpeedSchoolEscape",
    ["24HoursOvernight"] = "24HoursOvernight",
    ["24HoursinElevator"] = "24HoursinElevator",
    ["2PlayerStealBrainrot"] = "2PlayerStealBrainrot",
    ["7DaysToLive"] = "7DaysToLive",
    ["AnimeCardCollection"] = "AnimeCardCollection",
    ["BattleCatTraining"] = "BattleCatTraining",
    ["BeaYouTuber"] = "BeaYouTuber",
    ["BirdGame"] = "BirdGame",
    ["BladeSpin"] = "BladeSpin",
    ["BlindShot"] = "BlindShot",
    ["BlowUpandFall"] = "BlowUpandFall",
    ["BoxingSlayer"] = "BoxingSlayer",
    ["BrainrotSeas"] = "BrainrotSeas",
    ["BreakaLuckyBlock"] = "BreakaLuckyBlock",
    ["BridgetoBrainrot"] = "BridgetoBrainrot",
    ["BuildEscapefromBrainrot"] = "BuildEscapefromBrainrot",
    ["BuildaStoneMiner"] = "BuildaStoneMiner",
    ["CatchAndTame"] = "CatchAndTame",
    ["CatchBrainrotsFromRiver"] = "CatchBrainrotsFromRiver",
    ["ClimbForBrainrots"] = "ClimbForBrainrots",
    ["ClimbWormTowerforBrainrots"] = "ClimbWormTowerforBrainrots",
    ["DigLegends"] = "DigLegends",
    ["DiveDown"] = "DiveDown",
    ["DiveForBrainrots"] = "DiveForBrainrots",
    ["DontStealtheBrainrots"] = "DontStealtheBrainrots",
    ["DrawARaft"] = "DrawARaft",
    ["DrillBlockSimulator"] = "DrillBlockSimulator",
    ["DrivingEmpireEvent"] = "DrivingEmpireEvent",
    ["DuctTapeChallenge"] = "DuctTapeChallenge",
    ["EscapeGettingCrushedForBrainrots"] = "EscapeGettingCrushedForBrainrots",
    ["EscapeGuardstoStealBrainrots"] = "EscapeGuardstoStealBrainrots",
    ["EscapeLogsforBrainrots"] = "EscapeLogsforBrainrots",
    ["EscapeObbiesForBrainrots"] = "EscapeObbiesForBrainrots",
    ["EscapePoliceForBrainrots"] = "EscapePoliceForBrainrots",
    ["EscapeQuicksandforBrainrots"] = "EscapeQuicksandforBrainrots",
    ["EscapeTsunamiForBrainrots"] = "EscapeTsunamiForBrainrots",
    ["EscapeTsunamiForFish"] = "EscapeTsunamiForFish",
    ["EscapeTsunamiForLuckyBlocks"] = "EscapeTsunamiForLuckyBlocks",
    ["EscapeTsunamiforMemes"] = "EscapeTsunamiforMemes",
    ["FindWhoSlapped"] = "FindWhoSlapped",
    ["FireballTraining"] = "FireballTraining",
    ["FishForLuckyBlocks"] = "FishForLuckyBlocks",
    ["GardenHorizons"] = "GardenHorizons",
    ["GetTallandFall"] = "GetTallandFall",
    ["GiantSmash"] = "GiantSmash",
    ["GlideforBrainrots"] = "GlideforBrainrots",
    ["GrowBeanstalkForBrainrots"] = "GrowBeanstalkForBrainrots",
    ["GunSimulator"] = "GunSimulator",
    ["HowLongCanYouFart"] = "HowLongCanYouFart",
    ["JailaBrainrot"] = "JailaBrainrot",
    ["JellyJumpTraining"] = "JellyJumpTraining",
    ["JumpforBrainrots"] = "JumpforBrainrots",
    ["JumptoStealBrainrots"] = "JumptoStealBrainrots",
    ["KickDoorToEscape"] = "KickDoorToEscape",
    ["LeafCollector"] = "LeafCollector",
    ["MineaBrainrot"] = "MineaBrainrot",
    ["MyBrainrotArmy"] = "MyBrainrotArmy",
    ["MyCardCollection"] = "MyCardCollection",
    ["MyCatArmy"] = "MyCatArmy",
    ["MyMiningBrainrots"] = "MyMiningBrainrots",
    ["MySolarFarm"] = "MySolarFarm",
    ["NoobInvaders"] = "NoobInvaders",
    ["OPBlade"] = "OPBlade",
    ["PlaneRace"] = "PlaneRace",
    ["PrisonLiftClash"] = "PrisonLiftClash",
    ["ROBIT"] = "ROBIT",
    ["RaiseBrainrots"] = "RaiseBrainrots",
    ["RescueBrainrots"] = "RescueBrainrots",
    ["RunForBrainrots"] = "RunForBrainrots",
    ["SaveBrainrotfromLava"] = "SaveBrainrotfromLava",
    ["SaveBrainrotsFromBackrooms"] = "SaveBrainrotsFromBackrooms",
    ["SharkBite2"] = "SharkBite2",
    ["Shoota99Nights"] = "Shoota99Nights",
    ["ShredaBrainrot"] = "ShredaBrainrot",
    ["ShrimpGame"] = "ShrimpGame",
    ["Singapore"] = "Singapore",
    ["SirenHeadDance"] = "SirenHeadDance",
    ["SisyphusTraining"] = "SisyphusTraining",
    ["SkateboardObby"] = "SkateboardObby",
    ["SkatersOfHell"] = "SkatersOfHell",
    ["SkillPointEverySecond"] = "SkillPointEverySecond",
    ["Skinwalkers"] = "Skinwalkers",
    ["SlapFights"] = "SlapFights",
    ["SlasherBladeLoot"] = "SlasherBladeLoot",
    ["SlayerBlade"] = "SlayerBlade",
    ["SlayerTycoon"] = "SlayerTycoon",
    ["SleepyBrainrots"] = "SleepyBrainrots",
    ["SlimeSlayers"] = "SlimeSlayers",
    ["SmacktheBrainrots"] = "SmacktheBrainrots",
    ["SnowShovelBattle"] = "SnowShovelBattle",
    ["SonicEvent"] = "SonicEvent",
    ["SonicKarate"] = "SonicKarate",
    ["SonicSpeed"] = "SonicSpeed",
    ["SonicTornado"] = "SonicTornado",
    ["SpearTraining"] = "SpearTraining",
    ["Speed99NightsForest"] = "Speed99NightsForest",
    ["SpeedMaze"] = "SpeedMaze",
    ["StealFromBrainrots"] = "StealFromBrainrots",
    ["StealaRide"] = "StealaRide",
    ["StealanAnime"] = "StealanAnime",
    ["StealanAnime2"] = "StealanAnime2",
    ["StealnGrowaBrainrot"] = "StealnGrowaBrainrot",
    ["StickmanTD"] = "StickmanTD",
    ["StoptheZombiePlants"] = "StoptheZombiePlants",
    ["StrongmanUltra"] = "StrongmanUltra",
    ["StyleCity"] = "StyleCity",
    ["SummonYourTeam"] = "SummonYourTeam",
    ["SuperVillainTycoon"] = "SuperVillainTycoon",
    ["SuperheroLegends"] = "SuperheroLegends",
    ["SurfingandSlide"] = "SurfingandSlide",
    ["SurviveLAVAforBrainrots"] = "SurviveLAVAforBrainrots",
    ["SurviveZombieArena"] = "SurviveZombieArena",
    ["SwordLeague"] = "SwordLeague",
    ["SwordWarriors"] = "SwordWarriors",
    ["TRexHead"] = "TRexHead",
    ["TTitans"] = "TTitans",
    ["TankGame"] = "TankGame",
    ["TeamworkPuzzles"] = "TeamworkPuzzles",
    ["The67Evolution"] = "The67Evolution",
    ["TheGlassBridge"] = "TheGlassBridge",
    ["TheHatch"] = "TheHatch",
    ["TheHuntEattheWorld"] = "TheHuntEattheWorld",
    ["TheHuntWorldZero"] = "TheHuntWorldZero",
    ["TheJumpRope"] = "TheJumpRope",
    ["Throwstuff"] = "Throwstuff",
    ["TitanSmash"] = "TitanSmash",
    ["ToiletVerseTower"] = "ToiletVerseTower",
    ["TowerofZombies"] = "TowerofZombies",
    ["TrainForUGC"] = "TrainForUGC",
    ["TrainingToClimb"] = "TrainingToClimb",
    ["TraintoEscapePrison"] = "TraintoEscapePrison",
    ["TraintoFight"] = "TraintoFight",
    ["TraintobetheFastest"] = "TraintobetheFastest",
    ["TrapRun"] = "TrapRun",
    ["TrapandBait"] = "TrapandBait",
    ["UGCObby"] = "UGCObby",
    ["UltimateMining"] = "UltimateMining",
    ["UnboxFreeUGC"] = "UnboxFreeUGC",
    ["Unboxa99Nights"] = "Unboxa99Nights",
    ["UnboxaBrainrot"] = "UnboxaBrainrot",
    ["UnitsBattle"] = "UnitsBattle",
    ["UntitledFishingGame"] = "UntitledFishingGame",
    ["VersePiece"] = "VersePiece",
    ["WeaponFighting"] = "WeaponFighting",
    ["YoutuberEmpire"] = "YoutuberEmpire",
    ["mm2"] = "mm2",
    ["untitleddrill"] = "untitleddrill",
}
